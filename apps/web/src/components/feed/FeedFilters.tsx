...
const CATEGORIES = [
  { id: 'entertainment', name: 'Entertainment', emoji: '🎭', color: 'bg-purple-100 text-purple-800' },
  { id: 'education', name: 'Education', emoji: '📚', color: 'bg-blue-100 text-blue-800' },
  { id: 'lifestyle', name: 'Lifestyle', emoji: '🌟', color: 'bg-pink-100 text-pink-800' },
  { id: 'gaming', name: 'Gaming', emoji: '🎮', color: 'bg-green-100 text-green-800' },
  { id: 'technology', name: 'Technology', emoji: '💻', color: 'bg-indigo-100 text-indigo-800' },
  { id: 'fitness', name: 'Fitness', emoji: '💪', color: 'bg-orange-100 text-orange-800' },
  { id: 'cooking', name: 'Cooking', emoji: '👨‍🍳', color: 'bg-yellow-100 text-yellow-800' },
  { id: 'music', name: 'Music', emoji: '🎵', color: 'bg-red-100 text-red-800' },
  { id: 'art', name: 'Art', emoji: '🎨', color: 'bg-teal-100 text-teal-800' },
  { id: 'business', name: 'Business', emoji: '💼', color: 'bg-gray-100 text-gray-800' },
];

const CONTENT_TYPES = [
  { id: 'all', name: 'All Content', description: 'See everything' },
  { id: 'trending', name: 'Trending Only', description: 'What\'s hot right now' },
  { id: 'following', name: 'Following', description: 'From creators you follow' },
  { id: 'recommended', name: 'Recommended', description: 'Personalized for you' },
  { id: 'new', name: 'New Creators', description: 'Fresh voices' },
];

export default function FeedFilters({ selectedCategory, onCategoryChange, onClose }: FeedFiltersProps) {
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <label className="flex items-center">
                <input
                  ...
                  className="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"
                />
                <span className="ml-2 text-sm text-gray-700">Hide NSFW content</span>
              </label>
              ...
              <label className="flex items-center">
                <input
                  ...
                  className="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"
                />
                <span className="ml-2 text-sm text-gray-700">Active in last 7 days</span>
              </label>
              ...
              <label className="flex items-center">
                <input
                  ...
                  className="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"
                />
                <span className="ml-2 text-sm text-gray-700">Has free content</span>
              </label>
            </div>
        ...
        <div className="bg-blue-50 rounded-lg p-3">
          <div className="flex items-center space-x-2 text-sm text-blue-800">
            ...
            <span>
              ...
              {contentFilter !== 'all' && ` • ${CONTENT_TYPES.find(t => t.id === contentFilter)?.name}`}
            </span>
          </div>
        </div>
      )}
