...
function CreatorDashboardContent() {
  ...
  // tRPC queries
  const { data: verificationStatus } = trpc.creatorVerification.getVerificationStatus.useQuery();
  const { data: creatorStats, isLoading: statsLoading } = trpc.creatorMonetization.getCreatorStats.useQuery({
    timeRange: selectedTimeRange
  });
  const { data: revenueData, isLoading: revenueLoading } = trpc.creatorMonetization.getRevenueChart.useQuery({
    timeRange: selectedTimeRange
  });
  const { data: topPersonas } = trpc.creatorMonetization.getTopPerformingPersonas.useQuery({
    limit: 5
  });
        ...
        <div className="max-w-md mx-auto text-center">
          <div className="bg-white rounded-lg shadow-sm border p-8">
            ...
            <p className="text-gray-600 mb-6">
              You need to complete creator verification before accessing the creator dashboard.
            </p>
            <button
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between py-6">
            <div>
              ...
              <p className="text-gray-600">Track your earnings, manage subscribers, and grow your creator business</p>
            </div>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500" colSpan={6}>
                      <div className="text-center py-8">
                        ...
                        <p className="mt-1 text-sm text-gray-500">
                          Start monetizing your personas to see earnings appear here.
                        </p>
                        <div className="mt-6">
                          <button
                            onClick={() => router.push('/personas')}
