      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6">
            This persona doesn't exist or isn't available for subscription.
          </p>
          <button
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            {persona.description ||
              "Start meaningful conversations and build a connection with this digital persona."}
          </p>
        </div>
          ...
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <h3 className="text-lg font-medium text-gray-900">
                Created by {persona.creatorName || "Anonymous Creator"}
              </h3>
              <p className="text-sm text-gray-500">
                ✅ Verified Creator • 97% of your payment goes directly to the
                creator
              </p>
            </div>
          </div>
                  ...
                  >
                    ...
                    <div className="text-center">
                      ...
                      <div className="text-xs text-gray-500 space-y-1">
                        ...
                        <p>
                          •{" "}
                          {tier.priority.charAt(0).toUpperCase() +
                            tier.priority.slice(1)}{" "}
                          priority
                        </p>
                ...
                {isTimeBasedSelected && (
                  <div className="mb-4">
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setTimeBasedMinutes(Number(e.target.value))
                      }
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                      onClick={(e) => e.stopPropagation()}
                    >
                      <option value={60}>
                        1 hour - ${monetization.timeBasedPricing.pricePerHour}
                      </option>
                      <option value={30}>
                        30 minutes - $
                        {(
                          monetization.timeBasedPricing.pricePerHour / 2
                        ).toFixed(2)}
                      </option>
                      <option value={15}>
                        15 minutes - $
                        {(
                          monetization.timeBasedPricing.pricePerHour / 4
                        ).toFixed(2)}
                      </option>
                    </select>
                  </div>
